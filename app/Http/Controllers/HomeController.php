    ...
    public function portfolio(Request $request)
    {
        ...
        $allProjects = collect([
            ...
            [
                ...
                'image' => asset('assets/img/jas_pro_land/webp/proyek_baja_ringan_1.webp'),
                'alt' => 'Proyek Rangka Baja Ringan Rajeg Ciry Mansion',
                'filter' => 'baja'
            ],
            [
                'category' => 'Baja Ringan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_baja_ringan_2.webp'),
                'alt' => 'Proyek Rangka Baja Ringan Garden City Balaraja',
                'filter' => 'baja'
            ],
            [
                'category' => 'Baja Ringan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_baja_ringan_3.webp'),
                'alt' => 'Proyek Rangka Baja Ringan Granada Rajeg City',
                'filter' => 'baja'
            ],
            [
                'category' => 'Baja Ringan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_baja_ringan_4.webp'),
                'alt' => 'Proyek Rangka Baja Ringan Puri Sepatan',
                'filter' => 'baja'
            ],
            [
                'category' => 'Baja Ringan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_baja_ringan_5.webp'),
                'alt' => 'Proyek Rangka Baja Garden City Solear',
                'filter' => 'baja'
            ],
            [
                'category' => 'Baja Ringan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_baja_ringan_6.webp'),
            ...
            [
                ...
                'image' => asset('assets/img/jas_pro_land/webp/proyek_pembangunan_rumah_klasik_modern_serang.webp'),
                'alt' => 'Proyek Pembangunan Rumah Klasik Modern Serang',
                'filter' => 'pembangunan'
            ],
            [
                'category' => 'Pembangunan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_pembangunan_rumah_klasik_modern_serangg.webp'),
                'alt' => 'Proyek Pembangunan Rumah Klasik Modern Serang',
                'filter' => 'pembangunan'
            ],
            [
                'category' => 'Pembangunan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_pembangunan_rumah_klasik_modern_serang_2.webp'),
                'alt' => 'Proyek Pembangunan Rumah Klasik Modern Serang 2',
                'filter' => 'pembangunan'
            ],
            [
                'category' => 'Pembangunan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_pembangunan_rumah_klasik_modern_serangg_2.webp'),
                'alt' => 'Proyek Pembangunan Rumah Klasik Modern Serang 2',
                'filter' => 'pembangunan'
            ],
            [
                'category' => 'Pembangunan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_pembangunan_cafe_saung_serang.webp'),
                'alt' => 'Proyek Pembangunan Cafe Saung Serang',
                'filter' => 'pembangunan'
            ],
            [
                'category' => 'Pembangunan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_pembangunan_cafe_saung_serangg.webp'),
                'alt' => 'Proyek Pembangunan Cafe Saung Serang',
                'filter' => 'pembangunan'
            ],
            [
                'category' => 'Pembangunan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_pembangunan_ruko_dan_rumah_subsidi_mitra_garden_serang.webp'),
            ...
            [
                'category' => 'Tambang',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_tambang_pasir_1.webp'),
                'alt' => 'Proyek Tambang Pasir dan Batu Serang',
                'filter' => 'tambang'
            ],
            [
                'category' => 'Tambang',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_tambang_pasir_2.webp'),
                'alt' => 'Proyek Tambang Pasir dan Batu Serang 2',
                'filter' => 'tambang'
            ],
            [
                'category' => 'Tambang',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_tambang_pasir_3.webp'),
                'alt' => 'Proyek Tambang Pasir dan Batu Serang 3',
                'filter' => 'tambang'
            ],
            [
                'category' => 'Tambang',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_tambang_pasir_4.webp'),
                'alt' => 'Proyek Tambang Pasir dan Batu Serang 4',
                'filter' => 'tambang'
            ],
            [
                'category' => 'Tambang',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_tambang_pasir_5.webp'),
            ...
            [
                'category' => 'Urugan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_urugan_1.webp'),
                'alt' => 'Proyek Urugan Tanah Grand Harmony Balaraja',
                'filter' => 'urugan'
            ],
            [
                'category' => 'Urugan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_urugan_2.webp'),
                'alt' => 'Proyek Urugan Tanah Grand Harmony Balaraja 2',
                'filter' => 'urugan'
            ],
            [
                'category' => 'Urugan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_urugan_3.webp'),
                'alt' => 'Proyek Urugan Tanah Grand City The Extention',
                'filter' => 'urugan'
            ],
            [
                'category' => 'Urugan',
                'image' => asset('assets/img/jas_pro_land/webp/proyek_urugan_4.webp'),
