                ...
                <div class="col-lg-5" data-aos="zoom-out">
                    <div class="visual-content">
                        <div class="fluid-shape">
                            <img src="{{ url('assets/img/abstract/abstract-1.webp') }}" alt="Abstract Fluid Shape"
                                class="fluid-img">
                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <p>"Their dedication to delivering superior solutions and their meticulous
                                            ...
                                            trajectory."</p>
                                        <div class="client-info d-flex align-items-center mt-4">
                                            <img src="{{ url('assets/img/person/person-f-3.webp') }}" class="client-img"
                                                alt="Client" loading="lazy">
                                            <div>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
                ...
                <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
                    <img src="{{ url('assets/img/misc/misc-1.webp') }}" alt="Digital Platform"
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="profile d-flex align-items-center">
                                        <img src="{{ url('assets/img/person/person-m-7.webp') }}" class="profile-img"
                                            alt="">
                                ...
                                <div class="col-lg-4 d-none d-lg-block">
                                    <div class="featured-img-wrapper">
                                        <img src="{{ url('assets/img/person/person-m-7.webp') }}" class="featured-img"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="testimonial-item">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="profile d-flex align-items-center">
                                        <img src="{{ url('assets/img/person/person-f-8.webp') }}" class="profile-img"
                                            alt="">
                                        <div class="profile-info">
                                            <h3>Sara Wilsson</h3>
                                            <span>Designer</span>
                                ...
                                <div class="col-lg-4 d-none d-lg-block">
                                    <div class="featured-img-wrapper">
                                        <img src="{{ url('assets/img/person/person-f-8.webp') }}" class="featured-img"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="testimonial-item">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="profile d-flex align-items-center">
                                        <img src="{{ url('assets/img/person/person-m-9.webp') }}" class="profile-img"
                                            alt="">
                                        <div class="profile-info">
                                            <h3>Matt Brandon</h3>
                                ...
                                <div class="col-lg-4 d-none d-lg-block">
                                    <div class="featured-img-wrapper">
                                        <img src="{{ url('assets/img/person/person-m-9.webp') }}" class="featured-img"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="testimonial-item">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="profile d-flex align-items-center">
                                        <img src="{{ url('assets/img/person/person-f-10.webp') }}" class="profile-img"
                                            alt="">
                                        <div class="profile-info">
                                            <h3>Jena Karlis</h3>
                                ...
                                <div class="col-lg-4 d-none d-lg-block">
                                    <div class="featured-img-wrapper">
                                        <img src="{{ url('assets/img/person/person-f-10.webp') }}" class="featured-img"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{ url('assets/img/portfolio/portfolio-1.webp') }}"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{ url('assets/img/portfolio/portfolio-10.webp') }}"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{ url('assets/img/portfolio/portfolio-7.webp') }}"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{ url('assets/img/portfolio/portfolio-4.webp') }}"
                            ...
                            <figure class="entry-image">
                                ...
                                <div class="entry-overlay">
                                    <div class="overlay-content">
                                        ...
                                        <div class="entry-links">
                                            <a href="{{ url('assets/img/portfolio/portfolio-2.webp') }}"
                                                class="glightbox" data-gallery="portfolio-gallery-ui"
