        ...
        <div class="row gy-4 mb-5">
            ...
            <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="contact-info-box">
                    ...
                    <div class="info-content">
                        <h4>Alamat Email</h4>
                        <a href="mailto:prolandjas@gmailcom">prolandjas@gmail.com</a>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="input-with-icon">
                                        ...
                                        <textarea class="form-control" name="message" placeholder="Tulis pesan anda..." style="height: 180px" required=""></textarea>
                                    </div>
                                </div>
                            </div>
